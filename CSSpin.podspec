...
s.source = { :http => "https://github.com/MadhuNunc/CSSpin/archive/0.1.0.zip" }
...
s.vendored_frameworks = "CSSpin-0.1.0/Spin360.framework"

#s.vendored_frameworks = 'Spin360Demo.framework'
